    ...
    def maybe_offload_to_cpu(self, module: torch.nn.Module) -> torch.nn.Module:
        ...
        if offloaded_parameters:
            ...
            def forward(*args, **kwargs):
                ...
                # Kimi/DeepSeek-style MLA exposes tied attention weights through
                # multiple state_dict names. PyTorch 2.9 rejects the duplicate
                # keys unless we explicitly tell functional_call not to re-tie
                # them while temporarily materializing offloaded CPU weights.
