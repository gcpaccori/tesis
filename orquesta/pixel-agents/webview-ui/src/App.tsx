...
import { RoundtablePanel } from './components/RoundtablePanel.js';
  ...
  return (
    <div ref={containerRef} className="w-full h-full relative overflow-hidden">
      ...
      {!hooksInfoShown && !hooksTooltipDismissed && (
        ...
        >
          <span className="text-sm text-text leading-none">
            Your agents are now streaming into the office in real time.{' '}
            <span
      ...
      <Modal
        ...
        title="Live Agent Events are ON"
        zIndex={52}
      >
        <div className="text-base text-text px-10" style={{ lineHeight: 1.4 }}>
          <p className="mb-8">Your Pixel Agents office now reacts to local agent events:</p>
          ...
          <p className="mb-12 text-text-muted">
            This works through a local event bridge. Your own orchestrator or agents can post
            lifecycle events directly into Pixel Agents without depending on Claude.
          </p>
          ...
          <p className="mt-8 text-xs text-text-muted text-center">
            To disable, go to Settings {'>'} Live Agent Events
          </p>
        </div>
      </Modal>
